...
| Use Cloudformation to enable S3 inventory                                                                                | HTML          | [Stackoverflow Discussion](https://stackoverflow.com/questions/60615911/use-cloudformation-to-enable-s3-inventory)                                      | 2020-03-24        | Discussion with updates from the OP, which proofed very helpful for me.                                    |
| Using Python and Amazon SQS FIFO Queues to Preserve Message Sequencing                                                   | HTML          | [AWS Developer Blogs](https://aws.amazon.com/blogs/developer/using-python-and-amazon-sqs-fifo-queues-to-preserve-message-sequencing/)                   | 2017-03-29        | Examples of Python publishing to a FIFO SQS Queue                                                          | 
...
| [Lab 3](labs/lab3-non-kinesis-example/README.md)                                  | A lower volume example without Kinesis - ideal for a mixed environment                                                                 | Completed   |
| [Lab 4](labs/lab4-athena-query-s3-events/README.md)                               | Operations: replaying old events                                                                                                       | In Progress |
...
| Entry Date | Update                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
|:----------:|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2022-10-10 | The initial S3 event is now properly picked up and processed in terms of the DynamoDB object table. I still need to create the SQS FIFO queue for passing on the event to the appropriate event processor.                                                                                                                                                                                                                                                                                                                                                                                                |
| 2022-11-09 | The S3 buckets for new events and event archives have been created. The Lambda function skeletons to handle CREATE and DESTROY events for the S3 New Event Bucket have been created and the message parsing functions tested. ACtual Lambda functionality still to be implemented.                                                                                                                                                                                                                                                                                                                        |
| 2022-11-08 | STARTING LAB 4. Created initial CloudFormation stacks for Lab 4 and noted some more operational note. Still busy thinking about the best design and factors to take into account for backups, snapshot, recovery etc.                                                                                                                                                                                                                                                                                                                                                                                     |
